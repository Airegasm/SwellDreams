...
function GlobalTab() {
  ...
  return (
    <div className="settings-tab">
      ...
      {/* Global Character Controls removed: pump/device controls moved to Settings -> Pump Data -> Automatic Pumps -> Settings; "Use" Begins New Chat Session moved to the Characters page. */}
