...
function HamburgerMenu({ onNewSession, onSaveSession, onLoadSession, onHelpOpen }) {
  ...
  const MODAL_PAGES = ['/characters-personas', '/media-album', '/settings', '/dictionary'];
    ...
    <div className="hamburger-menu" ref={menuRef}>
      ...
      <div className={`hamburger-menu-panel ${isOpen ? 'open' : ''}`}>
        ...
        <NavLink
          ...
          className={({ isActive }) => `hamburger-menu-item ${isActive ? 'active' : ''}`}
          onClick={(e) => handleNavClick(e, '/characters-personas/characters')}
        >
          Characters
        </NavLink>
        ...
        <NavLink
          to="/media-album"
          className={({ isActive }) => `hamburger-menu-item ${isActive ? 'active' : ''}`}
          onClick={(e) => handleNavClick(e, '/media-album')}
        >
          Media Album
        </NavLink>
