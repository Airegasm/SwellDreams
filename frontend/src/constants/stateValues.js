...
export const EMOTIONS = [
  ...
  { key: 'mischievous', emoji: '\u{1F608}', label: 'Mischievous' },
  { key: 'defiant', emoji: '\u{1F624}', label: 'Defiant' },
  { key: 'bratty', emoji: '\u{1F612}', label: 'Bratty' },
  { key: 'eager', emoji: '\u{1F60B}', label: 'Eager' },
  { key: 'reluctant', emoji: '\u{1F61F}', label: 'Reluctant' },
  { key: 'resigned', emoji: '\u{1F614}', label: 'Resigned' },
  { key: 'stoic', emoji: '\u{1F611}', label: 'Stoic' },
  { key: 'desperate', emoji: '\u{1F62D}', label: 'Desperate' },
  { key: 'panicked', emoji: '\u{1F631}', label: 'Panicked' },
  { key: 'frightened', emoji: '\u{1F628}', label: 'Frightened' },
  { key: 'anxious', emoji: '\u{1F630}', label: 'Anxious' },
  { key: 'nervous', emoji: '\u{1F605}', label: 'Nervous' },
  { key: 'vulnerable', emoji: '\u{1F97A}', label: 'Vulnerable' },
  { key: 'overwhelmed', emoji: '\u{1F635}\u{200D}\u{1F4AB}', label: 'Overwhelmed' },
  { key: 'sad', emoji: '\u{1F622}', label: 'Sad' },
  { key: 'angry', emoji: '\u{1F620}', label: 'Angry' },
  { key: 'aggressive', emoji: '\u{1F92C}', label: 'Aggressive' },
  ...
  { key: 'euphoric', emoji: '\u{1F92F}', label: 'Euphoric' },
  { key: 'smug', emoji: '\u{1F60F}', label: 'Smug' },
  { key: 'flirtatious', emoji: '\u{1F618}', label: 'Flirtatious' },
  { key: 'detached', emoji: '\u{1F636}', label: 'Detached' },
  { key: 'broken', emoji: '\u{1F9D0}', label: 'Broken' },
  { key: 'fearful', emoji: '\u{1F627}', label: 'Fearful' },
  { key: 'hysterical', emoji: '\u{1F923}', label: 'Hysterical' },
  { key: 'manic', emoji: '\u{1F92A}', label: 'Manic' },
  { key: 'proud', emoji: '\u{1F60E}', label: 'Proud' },
  { key: 'humiliated', emoji: '\u{1F636}\u{200D}\u{1F32B}\u{FE0F}', label: 'Humiliated' },
  { key: 'adoring', emoji: '\u{1F979}', label: 'Adoring' },
  { key: 'spiteful', emoji: '\u{1F47F}', label: 'Spiteful' },
  { key: 'pleading', emoji: '\u{1F64F}', label: 'Pleading' }
];
