...
function ensureCharInflateFlowAssignments() {
  ...
  // Handle persona assignments — inject at session level so it works on any install
  if (settings.activePersonaId) {
    ...
    if (activePersona) {
      ...
      if (shouldHaveFlow) {
        // Ensure flow is in the persona's runtime flow list (don't require disk save)
        if (!activePersona.assignedFlows.includes(charInflateFlowId)) {
          activePersona.assignedFlows.push(charInflateFlowId);
          console.log(`[CharInflation] Added ${charInflateFlowId} to persona "${activePersona.displayName}" (runtime)`);
        }
        // Try to persist — save as custom (safe for both default and custom personas)
        try { imageStorage.savePersonaJson(activePersona, false); } catch (e) { /* best effort */ }
      } else {
        // Remove flow from persona if active character is not pumpable
        if (activePersona.assignedFlows.includes(charInflateFlowId)) {
      ...
      // Always sync buttons and session assignments
...
const BUILTIN_SKINS = [
  DEFAULT_SKIN,
  {
    ...
    uiCentralMenuBg: '#0d1f0d',
    uiCentralMenuTransparent: false,
    uiSelectorDescFontColor: '#8ab88a',
    uiModalBg: '',
    uiModalBgImage: '',
    ...
    rightSidebarBgImage: '',
    trimTopperColor: '#1a3a1a',
    trimCenterColor: '#0d2a0d',
    trimFooterColor: '#1a3a1a',
    nameBackingTransparent: false,
    nameBackingColor: 'rgba(10, 30, 10, 0.8)',
  ...
  },
  {
    ...
    uiCentralMenuBg: '#1a1815',
    uiCentralMenuTransparent: false,
    uiSelectorDescFontColor: '#a09080',
    uiModalBg: '',
    uiModalBgImage: '',
    ...
    rightSidebarBgImage: '',
    trimTopperColor: '#2a2520',
    trimCenterColor: '#1a1815',
    trimFooterColor: '#2a2520',
    nameBackingTransparent: false,
    nameBackingColor: 'rgba(25, 22, 18, 0.8)',
  ...
  ,{
    ...
    charActionMenuBg: 'linear-gradient(180deg, #2a1530 0%, #1a0820 20%, #2a1530 100%)',
    charActionBtnFace: 'linear-gradient(180deg, #3a2540 0%, #2a1530 50%, #1a0820 100%)',
    charActionBtnText: '#f0e0f8',
    personaActionMenuBg: '#1a0820',
  ...
  },
  {
    ...
    charActionMenuBg: 'linear-gradient(180deg, #1a0808 0%, #0d0202 20%, #1a0808 100%)',
    charActionBtnFace: 'linear-gradient(180deg, #2a1010 0%, #1a0808 50%, #0d0202 100%)',
    charActionBtnText: '#f0c8c8',
    personaActionMenuBg: '#0d0202',
  ...
  },
  {
    ...
    charActionMenuBg: 'linear-gradient(180deg, #050a15 0%, #020510 20%, #050a15 100%)',
    charActionBtnFace: 'linear-gradient(180deg, #0a1520 0%, #050a15 50%, #020510 100%)',
    charActionBtnText: '#ffc0f0',
    personaActionMenuBg: '#020510',
  ...
  },
  {
    ...
    charActionMenuBg: 'linear-gradient(180deg, #d0d8e0 0%, #c0c8d0 20%, #d0d8e0 100%)',
    charActionBtnFace: 'linear-gradient(180deg, #e0e8f0 0%, #d0d8e0 50%, #c0c8d0 100%)',
    charActionBtnText: '#1a2a40',
    personaActionMenuBg: '#d0d8e4',
  ...
  },
  {
    ...
    charActionMenuBg: 'linear-gradient(180deg, #061a18 0%, #031010 20%, #061a18 100%)',
    charActionBtnFace: 'linear-gradient(180deg, #0a2520 0%, #061a18 50%, #031010 100%)',
    charActionBtnText: '#b0e8d8',
    personaActionMenuBg: '#031010',
  ...
  },
  {
    ...
    charActionMenuBg: 'linear-gradient(180deg, #2a1018 0%, #1a0810 20%, #2a1018 100%)',
    charActionBtnFace: 'linear-gradient(180deg, #3a2028 0%, #2a1018 50%, #1a0810 100%)',
    charActionBtnText: '#fff0e0',
    personaActionMenuBg: '#1a0810',
